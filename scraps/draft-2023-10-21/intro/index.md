...
The software development system has a kind of life of its own: it comes into being, grows, persists for a time, and eventually "dies" or disappears. While the system lives, it can be "healthy" or "unhealthy". A healthy system is one that sustains itself, and tends toward self-maintenance and improvement. An unhealthy system tends toward death, unless enormous amounts of money are pumped in to keep it alive.
...
A healthy system is simply one without all of that. A lucky few of us have worked in healthy systems and have seen firsthand the excellent work that these systems can produce. My thesis, which I explore in detail in this book, is that **only a healthy system is capable of producing good software. If we want to make good software, we first need to create a healthy system.**

In my own career, I have been lucky to work in some of the healthiest systems in the software industry. I've seen firsthand what software development looks like when it is working well. (I've also had my share of failures, of course.) Both the successes and the failures have informed the advice in this book.
...
- _**Part I: Programming**_ is about how to write great code as a solo programmer. If you're working alone—say, on a side project of your own—Part I may have all the information you need.
<!--_Programming_ is the first part of the book because it's the foundation of everything we do. Our job, ultimately, boils down to getting computers to do what we want, reliably and cost-effectively.Although software design is, [as Kent Beck points out](https://tidyfirst.substack.com/p/coming-soon), an exercise in human relationships, relationships are founded on trust. Programmers earn trust by reliably delivering working software.--> 
- _**Part II: Working With Others**_ builds on Part I, extending the ideas from working alone to working on a team. It explores how to maintain and build trusting human relationships within a software development system, and how to keep that system healthy in the face of change and external pressures.<!-- It describes communication patterns and team dynamics that are good for the whole system—people _and_ code, employees _and_ customers.-->
- _**Part III: User Interfaces**_ discusses the principles behind user interface design. There is a shortage of UI and UX designers in many companies in 2023, so programmers are often implicitly called upon to make design decisions. This part of the book tries to ensure that the designs we produce will be comfortable and straightforward to use for the people who have to use them.
